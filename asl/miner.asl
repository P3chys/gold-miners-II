...
// More sophisticated gold evaluation
...
calculate_gold_utility(PathLength, GoldX, GoldY, Utility)
  :- 
     ...
     // Scoring factors
     BasePathPenalty = Utility1 * 10.0 &  // Base path cost
     DepotProximityBonus = DepotDistance / 15.0 &  // Favor gold near depot
     
     // Combine factors
     Utility = BasePathPenalty - DepotProximityBonus.
